...
Use General Sans at weight 500, line-height `0.92`, and letter-spacing `-0.055em`. Preserve the current responsive scale and two explicit block lines. Italicize only “every”; remove all other font switching, relative positioning, and custom inter-word spacing.
